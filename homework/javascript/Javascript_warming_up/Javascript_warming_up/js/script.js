...
// extract creator from index.html
p = document.getElementById('header').getElementsByTagName('p')
ApplePie.creator = p[0].textContent

// extract ingredients from index.html
items = document.getElementById('ingredient-list').getElementsByTagName('li')
for (var i = 0; i < items.length; i++){
	ApplePie.ingredients.push(items[i].textContent)
}
